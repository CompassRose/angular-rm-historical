...
export class DashboardApi {
  ...
  readonly MonthlyAvailable1_URL =
    './assets/dummyAPI/avail_by_month-test-1.csv';
  readonly MonthlyAvailable7_URL =
    './assets/dummyAPI/avail_by_month-test-07.csv';
  readonly MonthlyAvailable52_URL =
    './assets/dummyAPI/avail_by_month-test-52.csv';
  ...
  public getWorld(): Observable<any> {
    return this.http.get(this.myWorld, { responseType: 'text' }).pipe(
      map((res) => {
  ...
  public callApiQuery(args: string): Observable<any> {
    return this.http.get<ColumnValues>(args).pipe(
      map((res) => {
        console.log('\n\n\n res ', res);
        return res;
      }),
  ...
  getCsvData(): Observable<any[]> {
    return this.http.get(this.Seasonality_URL, { responseType: 'text' }).pipe(
      map((res) => {
  ...
  getKpiClusteredData(): Observable<any[]> {
    return this.http.get(this.KpiClusters_URL, { responseType: 'text' }).pipe(
      map((res) => {
  ...
  getMonthlyAvailableData(metric: any): Observable<any[]> {
    return this.http.get(this[`${metric}`], { responseType: 'text' }).pipe(
      map((res) => {
  ...
  getAirportCodes(): Observable<any[]> {
    return this.http.get(this.AirportCodes_URL, { responseType: 'text' }).pipe(
      map((res) => {
