...
export class DataService {
  ...
  private readonly flightCategorization_url: string =
    'tablerepo/table/__WebCategorization1a';
  private readonly flightscore_url = 'tablerepo/AllColumnsByModelType';
  private readonly migrateUpTables_url: string =
    'tablerepo/migrateup/__WebCategorization1a';
